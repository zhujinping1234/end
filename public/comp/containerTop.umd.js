;(function (o, e) {
  ...
  const l = {},
    n = (t) => (e.pushScopeId('data-v-eac7af96'), (t = t()), e.popScopeId(), t),
    r = { class: 'col' },
    i = { class: 'col-f' },
    a = n(() => e.createElementVNode('div', { 'data-slot': 'top' }, null, -1)),
    _ = { class: 'col-super' },
    p = { class: 'col-t' },
    f = n(() => e.createElementVNode('div', { 'data-slot': 'left' }, null, -1)),
    h = { class: 'col-b' },
  ...
  function m(t, s) {
    return (
      ...
      e.createElementBlock('div', r, [
        e.createElementVNode('div', i, [e.renderSlot(t.$slots, 'top', {}, () => [a], !0)]),
        e.createElementVNode('div', _, [
          e.createElementVNode('div', p, [e.renderSlot(t.$slots, 'left', {}, () => [f], !0)]),
